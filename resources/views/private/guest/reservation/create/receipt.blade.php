    ...
    <x-card.index class="max-w-2xl mx-auto p-6 sm:p-8 space-y-6">
        ...
        <div class="mt-6">
            <div
                ...
                <ol class="relative z-10 flex justify-between text-xs sm:text-sm font-medium text-gray-600">
                    ...
                    <li class="flex items-center gap-2 bg-white p-2">
                        <span class="size-6 rounded-full 
                            {{ in_array($status, ['confirmed', 'checkin', 'completed']) ? 'bg-violet-500 text-white' : 'bg-gray-100 text-gray-600' }}
...
{{-- Disable back navigation (biar user nggak bisa reload order page) --}}
<script>
